...
//Обработка исключений проводится внутри метода. Используем multi-catch block. Метод возвращает true, если значения верны или false
//в другом случае. (Задание с урока)
...
public class Task1 {
	...
	public static void Auth(String login, String logConf, String pass) {
