package by.academy.homework.hw3.validation;
...
public class BelarussianPhoneValidator implements Validator {
	...
	public static void main(String[] args) {
		...
		System.out.println("The number +375291000000 is " + (v.isValid("+375291000000") == true ? "valid" : "invalid"));

		System.out.println("The number +3754498765 is " + (v.isValid("+3754498765") == true ? "valid" : "invalid"));
